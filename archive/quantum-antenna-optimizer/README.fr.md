...
graph TD
    ...
    A["La conception d'antennes ultra-compactes pour les communications très hautes fréquences (5G/6G, communications spatiales) souffre de limitations thermiques et d'interférences insolubles par les approches d'ingénierie classiques."] --> B["Utilisation d'algorithmes d'optimisation quantique (VQE/QAOA) pour modéliser et générer des géométries d'antennes complexes (métamatériaux) qui maximisent le gain et minimisent la diaphonie spatiale."]
```
