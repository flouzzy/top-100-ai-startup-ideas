...
graph TD
    ...
    A["Traditional rigid robots break during unexpected impacts, while soft robots are too slow. Tensegrity-based robots (cables and rods) can absorb enormous shocks but are excruciatingly complex to control autonomously."] --> B["Dedicated operating system (OS) coupled to a neuromorphic chip embedding a real-time nonlinear dynamics solver, allowing decentralized proprioceptive control of locomotion and elastic deformation."]
```
