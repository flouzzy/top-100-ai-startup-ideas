...
> **Verdict VC :** Le stockage de données ADN est la seule solution à la crise imminente des exaoctets. L'encodage de données dans des bactéries vivantes représente un saut technique extrême. S'il est mis à l'échelle, il perturbe fondamentalement toute l'industrie des centres de données.
