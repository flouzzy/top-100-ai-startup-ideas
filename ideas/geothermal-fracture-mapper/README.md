...
graph TD
    ...
    A["Deep geothermal drilling suffers from a high failure rate (dry drilling) due to the difficulty in accurately mapping permeable underground fracture networks below 3km depth, making the cost of entry prohibitive."] --> B["Subsurface modeling using Neural Physics-accelerated seismic inversion models (PINNs) to create a predictive digital twin of rock fracturing and fluid circulation under very high pressure and temperature."]
```
