...
| Moat / Résistance aux LLM natifs  | 19 / 25         | 10 / 25              |
| Scalabilité / Friction d'adoption | 24 / 25         | 20 / 25              |
| Unit Economics / ROI direct       | 23 / 25         | 20 / 25              |
| **TOTAL**                         | **87 / 100**    | **71 / 100**         |
...
> **Verdict Terrain :** L'accumulation de fenêtres de contexte géantes entraîne une hausse vertigineuse des coûts, justifiant un garbage collector externe. Il bénéficie d'une intégration proxy facile, limitant la friction d'adoption. Le risque majeur vient des fournisseurs de LLM qui introduiront certainement des mécanismes d'attention dynamique et d'élagage en natif.
