...
graph TD
    ...
    Probleme["État Actuel"] --> Solution["État PQC ICS Shield"]
```
...
**Moat (Barrière à l'entrée) :** La standardisation encore en cours de certains algorithmes PQC, le coût d'intégration matériel dans des environnements hostiles (températures extrêmes, vibrations), les cycles de vente très longs (12-24 mois) en B2B industriel, et la nécessité de prouver qu'il n'y a aucune latence introduite (qui pourrait causer un dysfonctionnement physique).
