...
| **Calcul du CA (Target 100k€)** | (25 _299€_ 12) + (25 _10000€_ 2% \* 12) = 89 700€ (SaaS) + 60 000€ (Commissions) = 149 700€ ARR |
...
> **Verdict VC :** AutoRecouv résout une douleur B2B universelle avec un ROI instantanément mesurable en trésorerie. Son "Moat" d'intégration ERP le protège des concurrents génériques d'IA, ce qui en fait un candidat redoutable pour devenir l'infrastructure standard du recouvrement PME.
