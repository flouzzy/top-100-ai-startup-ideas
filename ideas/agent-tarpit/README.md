...
| --------------------------- | --------------- | ------------------- |
| Thesis & Monopoly / Urgency | 25 / 25         | 17 / 25             |
| Moat / LLM Immunity         | 22 / 25         | 23 / 25             |
| Scalability / UX Friction   | 23 / 25         | 16 / 25             |
| Unit Economics / ROI        | 22 / 25         | 19 / 25             |
| **TOTAL**                   | **92 / 100**    | **75 / 100**        |
...
> **Market Verdict:** Trapping malicious AI agents to exhaust their token budgets is a clever and effective defense mechanism. It enjoys high LLM immunity, as generic models cannot easily distinguish synthetic honeypots from real APIs. Monetization is viable for security-conscious B2B clients, though the friction of deploying and maintaining convincing tarpits is non-trivial.
